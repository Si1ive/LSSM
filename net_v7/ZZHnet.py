...
from net_v7.encoder_mamba import encoder
from net_v7.decoder_mamba import decoder, conv_small
...
class zzh_net(nn.Module):
    ...
    def forward(self, A, B):
        ...
        img1,img2,img3,img = self.decoder(torch.cat((A_lap, B_lap), dim=1), d1, d2, d3, d4, out1a, out1b, out2a, out2b, out3a, out3b,
                           out4a, out4b)
        img4 = self.clf(img)
