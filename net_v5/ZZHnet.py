...
from net_v5.encoder_mamba import encoder
from net_v5.decoder_mamba import decoder, conv_small
...
class zzh_net(nn.Module):
    def __init__(self, num_class):
        ...
        self.decoder = decoder([96, 192, 384, 768], num_class)

        self.clf = nn.Conv2d(96,2,1)
